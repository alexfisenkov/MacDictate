...
Подробные правила роста, лимиты файлов и запреты на смешение слоев закреплены в `docs/10_App_Architecture_Guardrails.md`. Любая будущая app-side правка должна сначала сверять слой ответственности с этим документом.
