...
- Публичная стабильная база: `v1.5.0`
...
- `releases/versions/v1.5.0/RELEASE.md` — карточка текущей stable.
- `releases/versions/v1.5.1-working/RELEASE.md` — следующая рабочая линия.
