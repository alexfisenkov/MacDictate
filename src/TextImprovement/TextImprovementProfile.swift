...
struct TextImprovementProfile {
    ...
    static let professionalCopyEditor = TextImprovementProfile(
        ...
        formattingRules: [
            ...
            "Сохраняй Markdown, если он уже был в исходном тексте. Если Markdown не нужен, верни обычный текст.",
        ...
        speechNormalizationHints: [
            ...
            "Клод от Anthropic / Cloud Anthropic -> Claude от Anthropic / Claude Anthropic",
